...
clear all
basename = 'home/elizabeth/Desktop/cshorex-main/osu_mangrove/data/HighDensity_h270_hv182_Wall_Clara' ;
% basename = 'HighDensity_h270_hv182_Wall_Clara' ;
%basename = 'Baseline_h270_hv185_NoWall'
%dnames = dir(['./',basename,'/T*']);
dnames = dir('/home/elizabeth/Desktop/cshorex-main/osu_mangrove/data/HighDensity_h270_hv182_Wall_Clara/T*') ;
...
for j = 1:length(dnames)
  ...
  %pressure 
  fnames = dir(fullfile(dname,'press*'));
  %fnames.name
