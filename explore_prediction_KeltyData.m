clear ; clc ; close all
plottingog = 1 ; plottingyn = 0 ; plottingpost = 0 ; %1 means plots, 0 means no plots
...
%basename = 'Baseline_h270_hv185_NoWall'
basename = 'HighDensity_h270_hv182_NoWall_old' ; 
cf = .05;
icorrect =1;
...
% for czex1 = 1:length(basenameog)
% basename = basenameog{czex1} ; 
