...
plottingog = 0 ; plottingyn = 0 ; plottingpost = 1 ; %1 means plots, 0 means no plots
%og section  % plotting error    %plotting stored data
addpath('./mfiles'); 
% basename = 'Baseline_h158_hv073_NoWall'; % pick which base name to use
% basename = 'Baseline_h270_hv185_NoWall';
 basename = 'HighDensity_h270_hv182_NoWall'; % original basename
% basename = 'HighDensity_h270_hv182_Wall';
%basename = 'Baseline_h270_hv185_NoWall'
...
for j = 1:6
  ...
  dname = ['~/data/osu_mangrove/',basename,'/',dnames(j).name,'/'];%same function as line 19
...
if plottingpost ==1 
figure(10); hold on; % Plotting Phase Averaged Error Line Graphs
     for num = 1:5
         subplot(3,2,num) ; 
             for num2 = 1:6
 ...
 figure(11) % scatterplot of Cd and Re
    subplot(1,2,1) ; 
